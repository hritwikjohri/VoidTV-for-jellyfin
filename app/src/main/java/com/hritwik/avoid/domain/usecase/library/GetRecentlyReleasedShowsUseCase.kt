...
class GetRecentlyReleasedShowsUseCase @Inject constructor(
    private val libraryRepository: LibraryRepository
) : BaseUseCase<GetRecentlyReleasedShowsUseCase.Params, List<MediaItem>>(Dispatchers.IO) {
    ...
    override suspend fun execute(parameters: Params): NetworkResult<List<MediaItem>> {
        return libraryRepository.getRecentlyReleasedShows(
