...
class GetLatestEpisodesUseCase @Inject constructor(
    private val libraryRepository: LibraryRepository
) : BaseUseCase<GetLatestEpisodesUseCase.Params, List<MediaItem>>(Dispatchers.IO) {
    ...
    override suspend fun execute(parameters: Params): NetworkResult<List<MediaItem>> {
        return libraryRepository.getLatestEpisodes(
