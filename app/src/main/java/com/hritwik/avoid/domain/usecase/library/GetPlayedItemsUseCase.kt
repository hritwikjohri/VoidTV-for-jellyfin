...
class GetPlayedItemsUseCase @Inject constructor(
    private val libraryRepository: LibraryRepository
) : BaseUseCase<GetPlayedItemsUseCase.Params, List<MediaItem>>(Dispatchers.IO) {
    ...
    override suspend fun execute(parameters: Params): NetworkResult<List<MediaItem>> {
        return libraryRepository.getPlayedItems(
